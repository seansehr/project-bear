...
<div class="other-products">
  <ul class="tabs other-products__tabs" data-tab>
    ...
    <li class="other-products__tab tab-title"><a href="#preorder" class="tab-link"><?php print t('Pre-Order') ?></a>
      <a href="/shopify-tags/preorder" class="tab__view-all"><?php print t('View<br />All'); ?></a>
    </li>
